...
namespace Nistec.Imex.Data
{
    public static class AdoExport
    {
        ...
        public static bool Export(ExportType exType,DataTable dt,string fileName,bool firstRowHeader,AdoField[] fields)
        {
            switch (exType)
            {
                case ExportType.Excel:
                    return Nistec.Imex.ExcelXml.Workbook.Export(dt, fileName, firstRowHeader, fields);
                case ExportType.Csv:
                    return Nistec.Imex.Csv.CsvWriter.Export(dt, fileName, firstRowHeader, fields);
                case ExportType.Html:
                    return Nistec.Imex.Html.HtmlWriter.Export(dt, fileName, firstRowHeader, fields);
                case ExportType.Xml:
                    return Nistec.Imex.Xml.XmlWriter.Export(dt, fileName, firstRowHeader, fields);
                case ExportType.Pdf:
                    throw new Exception("ExportType.Pdf not supported");//return Nistec.Imex.Pdf.PdfWriter.Export(dt, fileName, firstRowHeader, fields);
                default:
                    return Nistec.Imex.ExcelXml.Workbook.Export(dt, fileName, firstRowHeader, fields);
            }
        }
        ...
        public static bool Export(ExportType exType, DataTable dt, string fileName, bool firstRowHeader)
        {
            ...
            {
                case ExportType.Excel:
                    return Nistec.Imex.ExcelXml.Workbook.Export(dt, fileName, firstRowHeader,null);
                case ExportType.Csv:
                    return Nistec.Imex.Csv.CsvWriter.Export(dt, fileName, firstRowHeader);
                case ExportType.Html:
                    return Nistec.Imex.Html.HtmlWriter.Export(dt, fileName, firstRowHeader);
                case ExportType.Xml:
                    return Nistec.Imex.Xml.XmlWriter.Export(dt, fileName, firstRowHeader);
                case ExportType.Pdf:
                    throw new Exception("ExportType.Pdf not supported");//return Nistec.Imex.Pdf.PdfWriter.Export(dt, fileName, firstRowHeader);
                default:
                    return Nistec.Imex.ExcelXml.Workbook.Export(dt, fileName, firstRowHeader,null);
            }
        }
        ...
        public static void Export(DataTable dt, string fileName, bool firstRowHeader, AdoField[] fields)
        {
            ...
            if (fileName != "")
            {
                ...
                if (fileName.ToLower().EndsWith("csv"))
                    ...
                    throw new Exception("ExportType.Pdf not supported");//Export(ExportType.Pdf, dt, fileName, firstRowHeader, fields);

            }
        }

        public static void Export(DataTable dt, string fileName,bool firstRowHeader)
        {
            //string fileName = GetFileExportName();
            if (fileName != "")
            {
                ...
                if (fileName.ToLower().EndsWith("csv"))
                    ...
                    throw new Exception("ExportType.Pdf not supported");//Export(ExportType.Pdf, dt, fileName, firstRowHeader);
