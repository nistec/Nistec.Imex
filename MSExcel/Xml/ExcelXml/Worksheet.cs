namespace Nistec.Imex.ExcelXml
{
    ...
    public class Worksheet : Styles, IEnumerable<Cell>, IEnumerable
    {
        ...
        internal List<Nistec.Imex.ExcelXml.Range> _MergedCells;
        ...
        [CompilerGenerated]
        private Nistec.Imex.ExcelXml.PrintOptions _PrintOptions;
        ...
        internal Worksheet(Workbook parent)
        {
            ...
            this.PrintOptions = new Nistec.Imex.ExcelXml.PrintOptions();
            ...
            this._MergedCells = new List<Nistec.Imex.ExcelXml.Range>();
        ...
        private void ReadCell(XmlReader reader, Row row)
        {
            ...
            if (!isEmptyElement)
            {
                if ((rowIndex > 0) || (colIndex > 0))
                {
                    ...
                    Nistec.Imex.ExcelXml.Range range = new Nistec.Imex.ExcelXml.Range(cell, this.Cells(row.RowIndex + rowIndex, count + colIndex));
        ...
        {
            foreach (Nistec.Imex.ExcelXml.Range range in this._MergedCells)
            {
        ...
        public Nistec.Imex.ExcelXml.PrintOptions PrintOptions
        {
            [CompilerGenerated]
            get
            {
