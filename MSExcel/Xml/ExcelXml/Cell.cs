namespace Nistec.Imex.ExcelXml
{
    ...
    public class Cell : Styles
    {
        ...
        internal Nistec.Imex.ExcelXml.ContentType Content;
        ...
        internal Cell(Row parent, int index)
        {
            ...
            this.Content = Nistec.Imex.ExcelXml.ContentType.None;
        ...
        {
            //if (this.Content == Nistec.Imex.ExcelXml.ContentType.Formula)
            //{
            //    writer.WriteAttributeString("ss", "Formula", null, "=" + this.formula.ToString(this));
            //}
            if (this.Content == Nistec.Imex.ExcelXml.ContentType.UnresolvedValue)
            {
                writer.WriteAttributeString("ss", "Formula", null, (string) this._value);
            }
            else if (this.Content != Nistec.Imex.ExcelXml.ContentType.None)
            {
        ...
        public T GetValue<T>()
        {
            ...
            if (((!typeof(T).IsPrimitive && (fullName != "System.DateTime")) && (fullName != "System.String")) && (fullName != "Nistec.Imex.ExcelXml.Formula"))
            {
            ...
            {
                case Nistec.Imex.ExcelXml.ContentType.String:
                case Nistec.Imex.ExcelXml.ContentType.UnresolvedValue:
                ...
                //case Nistec.Imex.ExcelXml.ContentType.Formula:
                //    if (!(fullName == "Nistec.Imex.ExcelXml.Formula"))
                //    {
                //        return default(T);
                //    }
                //    return (T) this._value;
        ...
        public bool IsEmpty()
        {
            return (((this.Content == Nistec.Imex.ExcelXml.ContentType.None) && string.IsNullOrEmpty(this.Comment)) && base.HasDefaultStyle());
        }
        ...
        {
            if (this.formula!=null)// this.Content == Nistec.Imex.ExcelXml.ContentType.Formula)
            {
        ...
        public Nistec.Imex.ExcelXml.ContentType ContentType
        {
            get
            {
                return this.Content;
        ...
        public object Value
        {
            ...
            set
            {
                switch (value.GetType().FullName)
                {
                    case "System.DateTime":
                        this._value = value;
                        this.Content = Nistec.Imex.ExcelXml.ContentType.DateTime;
                        break;
                    ...
                    case "System.Decimal":
                        this._value = value;
                        this.Content = Nistec.Imex.ExcelXml.ContentType.Number;
                        break;

                    case "System.Boolean":
                        this._value = value;
                        this.Content = Nistec.Imex.ExcelXml.ContentType.Boolean;
                        break;

                    case "System.String":
                        this._value = value;
                        this.Content = Nistec.Imex.ExcelXml.ContentType.String;
                        break;

                    case "Nistec.Imex.ExcelXml.Cell":
                    {
                        ...
                        this.Content = cell.ContentType;// Nistec.Imex.ExcelXml.ContentType.Formula;
                        break;
                    }
                    case "Nistec.Imex.ExcelXml.Formula":
                    {
                        ...
                        this.Content = formula.ContentType;// Nistec.Imex.ExcelXml.ContentType.Formula;
                        break;
                    }
                    default:
