...
using System.Data.OleDb;
    ...
    public class ExcelTool 
    {
            ...
            try
            {
                ...
                switch (type)
                {
                    ...
                    case ExcelReaderType.ExcelOleDb:
                        ...
                        //MSExcel.OleDb.ExcelReader reader = new Nistec.Imex.MSExcel.OleDb.ExcelReader(properties);
        ...
        {
            //Nistec.Imex.MSExcel.Data.ExportUtil.GenerateWorkSheets(dt, fileName);
